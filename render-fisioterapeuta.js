...
const NARR = '/tmp/narr/narr-fisioterapeuta.mp3';
...
const outFile = path.join(OUT_DIR, 'fisioterapeuta-30s.mp4');
const imgs = [];
...
console.log(`\n[fisioterapeuta] ✅ ${outFile} — ${(stat.size/1024/1024).toFixed(1)} MB em ${((Date.now()-t0)/1000).toFixed(1)}s`);
